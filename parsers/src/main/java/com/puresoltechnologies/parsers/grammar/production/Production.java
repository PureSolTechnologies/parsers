...
public class Production implements Serializable {
    ...
    @JsonCreator
    public Production(@JsonProperty("id") int id, //
	    @JsonProperty("name") String name, //
	    @JsonProperty("alternativeName") String alternativeName, //
	    @JsonProperty("node") boolean node, //
	    @JsonProperty("stackingAllowed") boolean stackingAllowed, //
	...
	if (changed) {
	    ...
	    result = prime * result + ((constructions == null) ? 0 : constructions.hashCode());
