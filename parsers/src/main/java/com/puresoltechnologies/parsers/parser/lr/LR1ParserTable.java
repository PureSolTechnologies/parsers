...
public class LR1ParserTable extends AbstractParserTable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LR1ParserTable.class);
	...
	LR1ItemSetCollection itemSetCollection = new LR1ItemSetCollection(getGrammar(), closure1, goto1);
    ...
    private void writeTable(File directory, LR1ItemSetCollection itemSetCollection)
